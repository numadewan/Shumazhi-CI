<div class="container" style="padding:10;">
    ...
    <?php } ?>
        ...
        <a style="float: right;"class="btn-floating btn-large waves-effect waves-light light-green" href="<?php echo base_url(); ?>/product_registration"><i class="material-icons">add</i></a>
        <? echo 'hello'?>
    </div>
	</div>
<div>